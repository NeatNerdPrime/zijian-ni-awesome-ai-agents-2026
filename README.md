...
| **2026-05-14** | [Claude Code v2.1.141](https://github.com/anthropics/claude-code/releases/tag/v2.1.141) — Release notes document hook, plugin, session-management and reliability updates. | History |
