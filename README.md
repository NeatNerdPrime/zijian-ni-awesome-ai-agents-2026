...
[![Resources](https://img.shields.io/badge/Resources-610%2B-orange.svg)](#)
...
| **Jul 27, 2026** | Kimi K3 open weights released by Moonshot AI — 2.8T-parameter model becomes largest openly available language model at time of release | Models |
| **Jul 28, 2026** | MCP 2026-07-28 specification final release — stateless protocol, OAuth 2.1 alignment | Protocols |
...
*610+ resources across 25 categories — from foundation models to agent protocols to generative AI.*
