...
| [💱 Agent Economy & Marketplaces](#-agent-economy--marketplaces) | Where agents pay, get paid, and discover services | 5+ |
...
- [DeepSeek-V4-Pro](https://api-docs.deepseek.com/news/news260424) - 🆕 **April 24, 2026 (preview); production launch mid-July 2026**. 1.6T total / 49B active MoE, 1M-token context. MIT license. Leadership in agent capabilities, world knowledge, reasoning; tops open-source benchmarks. [Official pricing](https://api-docs.deepseek.com/quick_start/pricing) is flat (no peak/off-peak tiering): **$0.003625 cache-hit / $0.435 cache-miss input, $0.87 output** per 1M tokens, 384K max output, 500-request concurrency. `deepseek-v4-pro` / `deepseek-v4-flash` are the production API models.
- [DeepSeek-V4-Flash](https://api-docs.deepseek.com/news/news260424) - 🆕 April 24, 2026. 284B total / 13B active MoE, 1M context. MIT. Cost-efficient tier — **$0.0028 cache-hit / $0.14 cache-miss input, $0.28 output** per 1M tokens, 384K max output, 2,500-request concurrency ([pricing](https://api-docs.deepseek.com/quick_start/pricing)).
...
- [Cloudflare WebMCP](https://blog.cloudflare.com/agents-week-review-august-2026/) - 🆕 ⚡ **August 10, 2026 (Cloudflare Agents Week)**. One-line addition to make any website or web app discoverable and usable by AI agents — publishers retain control over access and pricing, while agents get structured access to web content. Part of Cloudflare's vision for an open Agentic Internet (readable, discoverable, callable, payable).
...
- [Microsoft Agent Framework](https://learn.microsoft.com/en-us/agent-framework/) - 🆕 Unified framework merging AutoGen + Semantic Kernel. Multi-agent conversations with enterprise features. **v1.12.1 (July 22, 2026)**: latest stable release after AutoGen + Semantic Kernel unification; improved multi-agent routing, enhanced observability hooks, and Grok 4.5 provider support.
...
- [CrewAI 1.15](https://github.com/crewAIInc/crewAI) - 🆕 ⚡ **Latest stable 1.15.15 (August 12, 2026)**. The 1.15 line adds **execution hooks and interception points** (wrap or veto a step before it runs), declarative Flows with CLI/TUI support, a Chat API for conversational agent flows, and native Snowflake Cortex support; LangChain was dropped from the core for a lighter dependency tree. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FcrewAIInc%2FcrewAI&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [Microsoft Agent Framework v1.13.0](https://github.com/microsoft/agent-framework/releases) - 🆕 ⚡ **2026-07-30**. MAF (merged AutoGen + Semantic Kernel) — bounded-memory MCP source skill discovery, reusable Foundry session storage, full-process feature-usage telemetry. Same release: **Agent Harness + Hosted Agents GA**. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fmicrosoft%2Fagent-framework&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
- [OpenAI Agents SDK v0.20.0](https://github.com/openai/openai-agents-python/releases/tag/v0.20.0) - 🆕 ⚡ **2026-08-11**. Default model changed to `gpt-5.6-luna`; MCP Python SDK v1 and v2 both supported (stdio, SSE, Streamable HTTP); local HTTP transport migration to `httpx2`. (Supersedes v0.19.0, which added Programmatic Tool Calling and `@tool` shorthand.) ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fopenai%2Fopenai-agents-python&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
- [CrewAI v1.15.15](https://github.com/crewAIInc/crewAI/releases/tag/1.15.15) - 🆕 ⚡ **2026-08-12**. Flow outcome/duration/human-in-the-loop reporting; FlowStartedEvent fix for aborted boundary hooks; torch 2.13.0 security bump; CLI flags standardized to kebab-case. (Supersedes v1.15.10 Jul-31 patch.) ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FcrewAIInc%2FcrewAI&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
- [Google ADK 2.6.x](https://github.com/google/adk-python/releases) - 🆕 ⚡ **Latest: v2.6.3 (Aug 7, 2026)**. 2.6.0: A2A per-invocation auth headers for agent-card fetching + proxy identity auth manager (3-legged OAuth); 2.6.1: CLI telemetry terminal grouping, TTL pruning, long-running web-server telemetry fix; 2.6.3: bug fix gating `--sandbox-launcher` behind `gcloud beta run deploy`. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fgoogle%2Fadk-python&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [A2A Protocol v1.0 + AP2 Agent Payments](https://github.com/google/A2A) - 🆕 ⚡ **2026-Q2 / ongoing**. A2A v1.0 (Linux Foundation) adds Signed Agent Cards (cryptographic identity), multi-protocol support, enterprise multi-tenancy, backward compatibility layer. AP2 (Agent Payment Protocol) joins with 60+ payment institution backing; 22,000+ GitHub stars; AWS/Microsoft/Google integrated. ⚠️ Unverified (multi-source confirmed; specific release announcement URL not directly fetched). ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fgoogle%2FA2A&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [Cloudflare Wallets](https://blog.cloudflare.com/agents-week-review-august-2026/) - 🆕 ⚡ **August 10, 2026 (Cloudflare Agents Week)**. Programmable wallet for the Agentic Internet — `cloudflare.pay` gives AI agents a secure way to make autonomous payments as participants in the agent economy. Launched alongside WriteGuard (fine-grained controls for risky MCP tool calls), WebMCP (one-line website-to-agent discoverability), MCPv2, and unified Workers AI + AI Gateway control plane as part of Cloudflare's Agents Week.
...
- [Cloudflare WriteGuard](https://blog.cloudflare.com/agents-week-review-august-2026/) - 🆕 ⚡ **August 10, 2026 (Cloudflare Agents Week)**. Fine-grained controls for risky MCP tool calls — the same tooling Cloudflare uses internally, now available to customers. Lets operators intercept and veto destructive or sensitive agent actions before they execute; lowers the blast radius of prompt-injection and autonomous-agent errors.
...
- [Agent Skills (addyosmani)](https://github.com/addyosmani/agent-skills) - 🆕 ⚡ **August 2026 (v0.6.6)**. Addy Osmani's production-grade engineering skills for AI coding agents — skills encode the workflows, quality gates, and best practices that senior engineers use (DEFINE → PLAN → BUILD → VALIDATE), packaged so agents follow them consistently across every development phase. MIT license; **86,000+ stars**. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Faddyosmani%2Fagent-skills&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
- [Cursor Router](https://cursor.com/) - 🆕 **July 2026**. Cursor's intelligent model-routing system analyzes each request and routes to the optimal model (Intelligence / Balance / Cost modes); integrates Grok 4.5 (trained on trillions of Cursor interaction tokens). Companion: Cursor iOS app (July 2026) for mobile development. Part of Cursor IDE.
...
- [DYNA-2](https://www.dyna.co/dyna-2) - 🆕 ⚡ **August 2026**. Dyna Robotics' world-action model trained on over **1 million hours** of robot experience — a 1-million-hour scaling law for world-action models enabling robots to complete end-to-end workflows in hospitality, logistics, and factory operations shift after shift. Mobile, dexterous, and intelligent simultaneously; every deployment strengthens the fleet and scales from one site to hundreds.
...
- [Perplexity Personal Computer for Windows](https://www.perplexity.ai/hub/blog/perplexity-personal-computer-for-windows) - 🆕 ⚡ **2026-07-28**. Expands to Windows 10/11 — local files + Microsoft 365 suite + cross-device workflows; orchestrates 19 AI models. Pro/Max/Enterprise subscribers. ⚠️ Unverified (URL 403; multi-source confirmed).
...
- [Cloudflare Kitesurf](https://blog.cloudflare.com/kitesurf/) - 🆕 ⚡ **August 2026 (beta)**. Cloudflare's new serverless browser built specifically for AI agents — runs on Workers, stateless and isolated per session, optimized for token count and context-window efficiency over pixel-perfect rendering. Supports Puppeteer and Playwright. Significantly more CPU/memory-efficient than Chromium for screenshot and HTML-extraction workloads. Free during beta via Cloudflare Browser Run. Trade-offs: no video playback, no WebGL, limited persistent-auth support.
...
- [ByteDance Seedance 2.5](https://www.bytedance.com/en/) - 🆕 ⚡ **2026-07-31 / 2026-08-03**. First large-scale AI video generation model supporting single-shot 30-second audio+video synthesis; up to 30 images + 10 videos + 10 audio clips as multi-modal reference input; local video editing. Launched on Dreamina first, global 2026-08-03. ⚠️ Unverified (Cloudflare-blocked; pandaily/prnewswire confirmed).
- [xAI Grok Voice Think Fast 2.0](https://x.ai/) - 🆕 ⚡ **2026-07-29** (API default upgrade 2026-08-05). Next-gen speech-to-speech: first-byte audio latency **1.25s → 0.70s**; transcription accuracy +1.4× across 24 languages; reasoning token usage −60%; $0.08/min. ⚠️ Unverified (x.ai Cloudflare-blocked; multi-source confirmed).
...
- [ByteDance SeedRealtime](https://bytedance.com/en/news/2026/seedrealtime) - 🆕 ⚡ 🇨🇳 **August 2026**. Native audio-visual full-duplex LLM from ByteDance — simultaneously watches, listens, and speaks in real time using a unified audio+video+text architecture. Replaces traditional cascaded voice-agent pipelines; reduces conversational pacing failures by ~50% in human evaluations. Deployed to 300M+ Doubao app users at launch. No public API or model weights yet.
...
- [Qwen 3.8-Max](https://qwenlm.github.io/) - 🆕 🇨🇳 **Preview July 19, 2026 (World AI Conference)**. Alibaba's next-generation MoE model — 2.4T parameters preview; strong coding, math, and multimodal capabilities. Full release details pending.
...
| **Aug 3, 2026** | [Claude Cowork](https://www.anthropic.com/claude-cowork) and [Claude Tag](https://www.businesswire.com/news/home/20260803/) launch — Cowork is Anthropic’s non-developer autonomous work agent (web + mobile + Slack); Tag replaces legacy Claude in Slack with channel-level persistent identity and async multi-day tasks. [Embabel Agent 1.0 GA](https://github.com/embabel/embabel-agent) — first production-ready JVM agent framework by Spring Framework’s creator Rod Johnson (3,878 stars, Apache-2.0). New 💱 Agent Economy & Marketplaces category added to this list | Frameworks / Tools |
...
*830+ resources across 26 categories — from foundation models to agent protocols, agent economy, and generative AI.*
