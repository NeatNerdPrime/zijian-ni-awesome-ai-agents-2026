...
| [Genkit](https://github.com/firebase/genkit) | Typed generation and agent flows | Apache-2.0 |
...
- [GPT-5.6 review-delay claim (unverified)](https://openai.com/) - ⚠️ Retrospective claim about a national-security review delaying GPT-5.6; the previously linked homepage does not substantiate the timing or an unprecedented-government-intervention claim, so the account remains unverified.
