...
[![Last Updated](https://img.shields.io/badge/Last%20Updated-September%202%2C%202026-blue.svg)](#)
...
|----------|-------------|-------|
| [🧠 Foundation Models](#-foundation-models-2026) | Latest LLMs from OpenAI, Anthropic, Google, Meta, and 22+ providers | 215+ |
| [🎨 Multimodal & Generative AI](#-multimodal--generative-ai) | Image, video, audio, and music generation | 50+ |
...
| [💱 Agent Economy & Marketplaces](#-agent-economy--marketplaces) | Where agents pay, get paid, and discover services | 8+ |
...
- [goose](https://github.com/block/goose) - ⚡ Open-source, extensible AI agent from Block (Rust desktop app + CLI) that installs, executes, edits, and tests with any LLM; 15+ providers; hosted by the Agentic AI Foundation (Linux Foundation). **v1.47.0 (August 21, 2026)**: interactive git-branch indicator, pre-registered OAuth clients for streamable_http extensions, recently-used models in the picker; concurrent-subagent notification isolation. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fblock%2Fgoose&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [Microsoft Agent Framework](https://learn.microsoft.com/en-us/agent-framework/) - 🆕 Unified framework merging AutoGen + Semantic Kernel. Multi-agent conversations with enterprise features. **python-1.15.0 / dotnet-1.19.0 (August 21–22, 2026)** are the latest stables; recent versions added improved multi-agent routing, enhanced observability hooks, and Grok provider support.
...
- [CrewAI 1.15](https://github.com/crewAIInc/crewAI) - 🆕 ⚡ **Latest stable 1.15.17 (August 20, 2026)**. The 1.15 line adds **execution hooks and interception points** (wrap or veto a step before it runs), declarative Flows with CLI/TUI support, a Chat API for conversational agent flows, and native Snowflake Cortex support; LangChain was dropped from the core for a lighter dependency tree. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FcrewAIInc%2FcrewAI&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [Cursor 3.11](https://cursor.com/changelog) - 🆕 ⚡ **July 10, 2026**. Side Chats (parallel AI conversations without disrupting main workflow), conversation history search, redesigned project/repo pickers, new Cloud Agent Hooks (granular control + observability over agent conversations — prompts, responses, sub-agent activities). **August 2026**: Google Workspace plugins let agents access Gmail/Drive/Calendar (Aug 3); pre-built dev environments make Cloud Agents start **3× faster** (Aug 13); **Aug 17** [Cursor Origin](https://cursor.com/changelog) early-beta git forge (host or GitHub-mirror repos, two-way PRs, agents next to the code); **Aug 19** adds Cloud Agent **Subscriptions** (wake on PRs / Slack / schedules), Custom Modes (pinned skills), subagents on their own VMs, `/goal` long-lived objectives, and non-interrupt steering.
...
- [OpenHands](https://github.com/All-Hands-AI/OpenHands) - Open-source platform for AI software developers as autonomous agents. ⚡ **v1.15.0 (August 21, 2026)** — automations catalog/script bundles, LLM provider-connections UI, conversation overview panel. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FAll-Hands-AI%2FOpenHands&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [Unitree Shanghai IPO](https://finance.eastmoney.com/a/202608193846301835.html) - 🆕 ⚡ 🇨🇳 **Listed August 19, 2026** (online offering Aug 10). Unitree becomes China's first listed humanoid/legged-robot maker on the SSE STAR Market (688836) — 40.45M shares at RMB 150.80, raising ~RMB 6.10B (~$850M); FY2025 revenue RMB 1.70B, net profit RMB 278M. Retail subscription oversubscribed thousands of times (Bloomberg: 5,526×) with a sharply higher gray-market debut. A milestone for the commercial humanoid sector.
...
- [Waymo](https://waymo.com/) - ⚡ Continuing commercial L4 rollout in US cities through 2026. **August 14, 2026**: the CPUC cleared Waymo to operate paid driverless robotaxi service across [18 California counties](https://electrek.co/2026/08/14/waymo-cpuc-approval-california-expansion-18-counties/) (Bay Area, Sacramento, LA, Orange, San Diego and more) — its largest authorization to date, including freeways, rural roads, and night driving; rollout "gradual and guided by our safety framework." **August 20**: [Houston opened to anyone](https://waymo.com/blog/shorts/houston-open-to-all/) after 100,000+ waitlist riders; same day Waymo published its [onboard compute stack](https://waymo.com/blog/2026/08/look-under-our-trunk/), including a purpose-built **5nm ASIC** that fuses lidar/radar/camera (>1,000 TOPS front-end ML). **August 25**: [Munich / Germany](https://waymo.com/blog/2026/08/waymo-in-munich/) — manual mapping now, commercial robotaxi targeted toward end of 2027.
...
- [Browser Use](https://github.com/browser-use/browser-use) - **v0.13.8 (August 16, 2026)**. Make websites accessible for AI agents with browser automation. The de-facto open-source choice in 2026, 109K+ stars. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fbrowser-use%2Fbrowser-use&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
| **Aug 19, 2026** | [Cursor Cloud Agent Subscriptions + /goal + VM-isolated subagents](https://cursor.com/changelog); [OpenAI Zero Data Retention](https://openai.com/index/offering-zero-data-retention-for-frontier-models) reaffirmed for eligible API customers; [OpenAI Agents SDK v0.22.0](https://github.com/openai/openai-agents-python/releases/tag/v0.22.0) | Tools |
| **Aug 21, 2026** | [DeepSeek-V4-Flash-Vision-Exp](https://api-docs.deepseek.com/news/news260821) multimodal API + Files API; DeepSeek Harness **dsh-v0.1.1-rc.2**; [goose v1.47.0](https://github.com/block/goose/releases/tag/v1.47.0); [OpenHands v1.15.0](https://github.com/All-Hands-AI/OpenHands/releases/tag/v1.15.0); [MAF python-1.15.0](https://github.com/microsoft/agent-framework/releases) | Models / Tools |
...
*910+ resources across 26 categories — from foundation models to agent protocols, agent economy, and generative AI.*
