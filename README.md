...
- [OpenAI Agents SDK v0.19.0](https://github.com/openai/openai-agents-python/releases/tag/v0.19.0) - 🆕 ⚡ **2026-07-27**. Programmatic Tool Calling (model generates JS to orchestrate tools); new `agents.decorators` module with `@tool` shorthand; hardened MCP/Realtime/session security logging; VercelCloudBucketMountStrategy. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fopenai%2Fopenai-agents-python&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
- [CrewAI v1.15.10](https://github.com/crewAIInc/crewAI/releases/tag/1.15.10) - 🆕 ⚡ **2026-07-31**. Skills-usage observability events; `bedrock-agentcore` dependency security patch; improved documentation and security reporting standards. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2FcrewAIInc%2FcrewAI&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
- [Google ADK 2.6.0 / 2.6.1](https://github.com/google/adk-python/releases) - 🆕 ⚡ **2026-07-29 / 07-31**. 2.6.0: A2A per-invocation auth headers for agent-card fetching + proxy identity auth manager (3-legged OAuth); 2.6.1: CLI telemetry terminal grouping, TTL pruning, long-running web-server telemetry fix. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Fgoogle%2Fadk-python&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
...
- [aws-bench](https://github.com/aws-samples/aws-bench) - 🆕 Open-source benchmark from AWS for evaluating AI agents on AWS-specific tasks — service API knowledge, IAM reasoning, and multi-step cloud operations. ![GitHub stars](https://img.shields.io/badge/dynamic/json?label=Stars&query=%24.stargazers_count&url=https%3A%2F%2Fapi.github.com%2Frepos%2Faws-samples%2Faws-bench&color=yellow&logo=github&logoColor=white&style=flat&cacheSeconds=300)
